...
class srcApp_KernelProdContainer extends Container
{
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig\Environment($a, ['form_themes' => [0 => 'form_div_layout.html.twig', 1 => '@FOSCKEditor/Form/ckeditor_widget.html.twig', 2 => '@FOSCKEditor/Form/ckeditor_widget.html.twig', 3 => 'bootstrap_4_layout.html.twig'], 'default_path' => ($this->targetDirs[3].'/templates'), 'debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception::showAction', 'autoescape' => 'name', 'cache' => ($this->targetDirs[0].'/twig'), 'charset' => 'UTF-8', 'paths' => [], 'date' => ['format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL], 'number_format' => ['decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',']]);
    ...
    {
        return $this->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('HhsTSDfHbj', 0, $this->getParameter('container.build_id'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
