...
class __TwigTemplate_90b4fd7c7f19dbbf0ae4dec702266f5ec86abbfcbd526b0025784252492240a0 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    : \$view['form']->humanize(\$name); } ?>
<button type=\"<?php echo isset(\$type) ? \$view->escape(\$type) : 'button' ?>\" <?php echo \$view['form']->block(\$form, 'button_attributes') ?>><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$label, [], \$translation_domain) : \$label) ?></button>
", "@Framework/Form/button_widget.html.php", "/home/manon/Documents/Projets perso/memories/vendor/symfony/framework-bundle/Resources/views/Form/button_widget.html.php");
    }
}
