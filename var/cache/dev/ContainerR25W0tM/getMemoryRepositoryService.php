...
// Returns the private 'App\Repository\MemoryRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/MemoryRepository.php';

return $this->privates['App\\Repository\\MemoryRepository'] = new \App\Repository\MemoryRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
